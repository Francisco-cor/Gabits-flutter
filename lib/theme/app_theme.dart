  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      appBarTheme: const AppBarTheme(
        ...
        iconTheme: IconThemeData(color: primaryAppColor, size: 22.0),
        actionsIconTheme: IconThemeData(color: primaryAppColor, size: 22.0),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        ...
        iconTheme: const IconThemeData(color: darkPrimary, size: 22.0),
        actionsIconTheme: const IconThemeData(color: darkPrimary, size: 22.0),
        titleTextStyle: TextStyle(
          fontFamily: preferredFontFamily,
          fontSize: 19,
          fontWeight: FontWeight.w500,
